...
.method public execute(Lorg/apache/http/conn/routing/HttpRoute;Lorg/apache/http/client/methods/HttpRequestWrapper;Lorg/apache/http/client/protocol/HttpClientContext;Lorg/apache/http/client/methods/HttpExecutionAware;)Lorg/apache/http/client/methods/CloseableHttpResponse;
    ...
    .line 106
    .local v6, "config":Lorg/apache/http/client/config/RequestConfig;
    ...
    .line 108
    .local v0, "currentRoute":Lorg/apache/http/conn/routing/HttpRoute;
    move-object/from16 v8, p2

    .line 109
    .local v8, "currentRequest":Lorg/apache/http/client/methods/HttpRequestWrapper;
    const/4 v9, 0x0
    ...
    .line 110
    .end local v0    # "currentRoute":Lorg/apache/http/conn/routing/HttpRoute;
    .local v8, "currentRoute":Lorg/apache/http/conn/routing/HttpRoute;
    .local v9, "currentRequest":Lorg/apache/http/client/methods/HttpRequestWrapper;
    ...
    .line 113
    .local v12, "response":Lorg/apache/http/client/methods/CloseableHttpResponse;
    :try_start_0
    ...
    .line 123
    .local v0, "redirect":Lorg/apache/http/HttpRequest;
    ...
    .line 125
    .local v13, "original":Lorg/apache/http/HttpRequest;
    ...
    .line 127
    .end local v13    # "original":Lorg/apache/http/HttpRequest;
    :cond_2
    ...
    .line 143
    .local v15, "targetAuthState":Lorg/apache/http/auth/AuthState;
    if-eqz v15, :cond_4

    .line 144
    move-object/from16 v16, v0

    .end local v0    # "redirect":Lorg/apache/http/HttpRequest;
    .local v16, "redirect":Lorg/apache/http/HttpRequest;
    ...
    .line 143
    .end local v16    # "redirect":Lorg/apache/http/HttpRequest;
    .restart local v0    # "redirect":Lorg/apache/http/HttpRequest;
    :cond_4
    move-object/from16 v16, v0

    .line 147
    .end local v0    # "redirect":Lorg/apache/http/HttpRequest;
    .restart local v16    # "redirect":Lorg/apache/http/HttpRequest;
    :goto_2
    ...
    .line 148
    .local v0, "proxyAuthState":Lorg/apache/http/auth/AuthState;
    if-eqz v0, :cond_7
    ...
    .local v17, "authScheme":Lorg/apache/http/auth/AuthScheme;
    ...
    .line 150
    .end local v17    # "authScheme":Lorg/apache/http/auth/AuthScheme;
    .restart local v3    # "authScheme":Lorg/apache/http/auth/AuthScheme;
    :cond_5
    move-object/from16 v17, v3

    .end local v3    # "authScheme":Lorg/apache/http/auth/AuthScheme;
    .restart local v17    # "authScheme":Lorg/apache/http/auth/AuthScheme;
    goto :goto_3

    .line 141
    .end local v15    # "targetAuthState":Lorg/apache/http/auth/AuthState;
    .end local v16    # "redirect":Lorg/apache/http/HttpRequest;
    .end local v17    # "authScheme":Lorg/apache/http/auth/AuthScheme;
    .local v0, "redirect":Lorg/apache/http/HttpRequest;
    :cond_6
    ...
    .line 184
    .end local v12    # "response":Lorg/apache/http/client/methods/CloseableHttpResponse;
    move-object/from16 v3, p1
    ...
    .line 136
    .restart local v0    # "redirect":Lorg/apache/http/HttpRequest;
    .restart local v12    # "response":Lorg/apache/http/client/methods/CloseableHttpResponse;
    .restart local v13    # "uri":Ljava/net/URI;
    .restart local v14    # "newTarget":Lorg/apache/http/HttpHost;
    :cond_9
    move-object/from16 v16, v0
    ...
    .end local v6    # "config":Lorg/apache/http/client/config/RequestConfig;
    .end local v7    # "maxRedirects":I
    .end local v8    # "currentRoute":Lorg/apache/http/conn/routing/HttpRoute;
    .end local v9    # "currentRequest":Lorg/apache/http/client/methods/HttpRequestWrapper;
    ...
    .restart local v6    # "config":Lorg/apache/http/client/config/RequestConfig;
    .restart local v7    # "maxRedirects":I
    .restart local v8    # "currentRoute":Lorg/apache/http/conn/routing/HttpRoute;
    .restart local v9    # "currentRequest":Lorg/apache/http/client/methods/HttpRequestWrapper;
