...
.method private static body([III)[I
    ...
    invoke-static {v1, v0, v6, v5, v4}, Lorg/apache/commons/codec/digest/UnixCrypt;->permOp(IIII[I)V
    ...
    invoke-static {v0, v1, v7, v8, v4}, Lorg/apache/commons/codec/digest/UnixCrypt;->permOp(IIII[I)V
    ...
    invoke-static {v1, v0, v3, v7, v4}, Lorg/apache/commons/codec/digest/UnixCrypt;->permOp(IIII[I)V
    ...
    invoke-static {v1, v0, v8, v7, v4}, Lorg/apache/commons/codec/digest/UnixCrypt;->permOp(IIII[I)V
...
.method public static crypt([BLjava/lang/String;)Ljava/lang/String;
    ...
    .line 213
    sget-object v7, Lorg/apache/commons/codec/digest/UnixCrypt;->CON_SALT:[I
    ...
    .end local v12    # "i":I
    :cond_2
    invoke-static {v11}, Lorg/apache/commons/codec/digest/UnixCrypt;->desSetKey([B)[I

    move-result-object v12

    .line 226
    .local v12, "schedule":[I
    invoke-static {v12, v8, v7}, Lorg/apache/commons/codec/digest/UnixCrypt;->body([III)[I
    ...
    invoke-static {v15, v14, v3}, Lorg/apache/commons/codec/digest/UnixCrypt;->intToFourBytes(I[BI)V

    .line 229
    aget v5, v13, v5

    invoke-static {v5, v14, v9}, Lorg/apache/commons/codec/digest/UnixCrypt;->intToFourBytes(I[BI)V
    ...
    :goto_6
    sget-object v0, Lorg/apache/commons/codec/digest/UnixCrypt;->COV2CHAR:[I
    ...
    .end local v7    # "eSwap1":I
    .end local v8    # "eSwap0":I
    .end local v9    # "u":I
    .end local v11    # "key":[B
...
.method private static desSetKey([B)[I
    ...
    invoke-static {v5, v3, v4, v8, v7}, Lorg/apache/commons/codec/digest/UnixCrypt;->permOp(IIII[I)V
    ...
    invoke-static {v3, v10, v9}, Lorg/apache/commons/codec/digest/UnixCrypt;->hPermOp(III)I

    move-result v3

    .line 347
    invoke-static {v5, v10, v9}, Lorg/apache/commons/codec/digest/UnixCrypt;->hPermOp(III)I
    ...
    invoke-static {v5, v3, v8, v9, v7}, Lorg/apache/commons/codec/digest/UnixCrypt;->permOp(IIII[I)V
    ...
    invoke-static {v3, v5, v10, v11, v7}, Lorg/apache/commons/codec/digest/UnixCrypt;->permOp(IIII[I)V
    ...
    .line 361
    sget-object v13, Lorg/apache/commons/codec/digest/UnixCrypt;->SHIFT2:[Z
    ...
    ushr-int/lit8 v16, v3, 0x14

    and-int/lit8 v16, v16, 0x1

    ushr-int/lit8 v18, v3, 0x15
    ...
    ushr-int/lit8 v18, v3, 0x16

    and-int/lit8 v18, v18, 0x38
    ...
    ushr-int/lit8 v18, v5, 0x7

    and-int/lit8 v17, v18, 0x3
