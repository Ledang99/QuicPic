...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lb/a/jb;->c:Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lb/a/jb;->a:Ljava/lang/String;

    const-string v0, "a_end_time"

    iput-object v0, p0, Lb/a/jb;->b:Ljava/lang/String;
...
.method private a(Landroid/content/Context;Landroid/content/SharedPreferences;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lb/a/il;->a(Landroid/content/Context;)Lb/a/il;

    move-result-object v1

    invoke-virtual {p0, p1}, Lb/a/jb;->b(Landroid/content/Context;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {p0, p1}, Lb/a/jb;->a(Landroid/content/Context;)Lb/a/i;
    ...
    invoke-virtual {v1, v0}, Lb/a/il;->a(Lb/a/is;)V
...
.method private b(Landroid/content/SharedPreferences;)Z
    ...
    invoke-static {v1, v2}, Lb/a/ge;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public static e(Landroid/content/Context;)Ljava/lang/String;
    ...
    sget-object v0, Lb/a/jb;->c:Ljava/lang/String;
...
# virtual methods
.method public a(Landroid/content/Context;)Lb/a/i;
    .locals 14

    invoke-static {p1}, Lb/a/iy;->a(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    :cond_1
    new-instance v8, Lb/a/i;

    invoke-direct {v8}, Lb/a/i;-><init>()V

    invoke-virtual {v8, v2}, Lb/a/i;->a(Ljava/lang/String;)Lb/a/fb;

    invoke-virtual {v8, v4, v5}, Lb/a/i;->a(J)Lb/a/fb;

    invoke-virtual {v8, v6, v7}, Lb/a/i;->b(J)Lb/a/fb;

    invoke-virtual {v8, v0, v1}, Lb/a/i;->c(J)Lb/a/fb;

    invoke-static {}, Lcom/c/a/a;->b()[D

    move-result-object v0

    if-eqz v0, :cond_2

    new-instance v1, Lb/a/do;
    ...
    invoke-direct/range {v1 .. v7}, Lb/a/do;-><init>(DDJ)V

    invoke-virtual {v8}, Lb/a/i;->f()Z

    move-result v0

    if-eqz v0, :cond_5

    invoke-virtual {v8, v1}, Lb/a/i;->a(Lb/a/do;)V

    :cond_2
    :goto_1
    invoke-static {p1}, Lb/a/d;->a(Landroid/content/Context;)Lb/a/fi;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-virtual {v8, v0}, Lb/a/i;->a(Lb/a/fi;)Lb/a/fb;

    :cond_3
    invoke-static {v9}, Lb/a/e;->a(Landroid/content/SharedPreferences;)Ljava/util/List;
    ...
    invoke-virtual {v8, v0}, Lb/a/i;->a(Ljava/util/List;)Lb/a/fb;

    :cond_4
    invoke-direct {p0, v9}, Lb/a/jb;->a(Landroid/content/SharedPreferences;)V
    ...
    invoke-virtual {v8, v0}, Lb/a/i;->b(Ljava/util/List;)Lb/a/fb;
...
.method public c(Landroid/content/Context;)V
    ...
    :cond_0
    invoke-direct {p0, v0}, Lb/a/jb;->b(Landroid/content/SharedPreferences;)Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-direct {p0, p1, v0}, Lb/a/jb;->a(Landroid/content/Context;Landroid/content/SharedPreferences;)Ljava/lang/String;
    ...
    invoke-static {v1, v0}, Lb/a/ge;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public d(Landroid/content/Context;)V
    ...
    sget-boolean v1, Lcom/c/a/a;->h:Z
