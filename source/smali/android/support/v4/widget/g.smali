...
.field private c:Landroid/support/v4/widget/l;
...
.method public constructor <init>(Landroid/support/v4/widget/DrawerLayout;I)V
    ...
    iput p2, p0, Landroid/support/v4/widget/g;->b:I

    return-void
.end method

.method static synthetic a(Landroid/support/v4/widget/g;)V
    .locals 0

    invoke-direct {p0}, Landroid/support/v4/widget/g;->c()V
...
.method private b()V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/widget/DrawerLayout;->k(Landroid/view/View;)V
...
.method private c()V
    ...
    iget-object v1, p0, Landroid/support/v4/widget/g;->c:Landroid/support/v4/widget/l;

    invoke-virtual {v1}, Landroid/support/v4/widget/l;->b()I
    ...
    invoke-virtual {v0, v2}, Landroid/support/v4/widget/DrawerLayout;->c(Landroid/view/View;)I
    ...
    iget-object v3, p0, Landroid/support/v4/widget/g;->c:Landroid/support/v4/widget/l;

    invoke-virtual {v2}, Landroid/view/View;->getTop()I

    move-result v5

    invoke-virtual {v3, v2, v1, v5}, Landroid/support/v4/widget/l;->a(Landroid/view/View;II)Z
...
.method public a(Landroid/view/View;)I
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/DrawerLayout;->i(Landroid/view/View;)Z
...
.method public a(I)V
    ...
    iget-object v2, p0, Landroid/support/v4/widget/g;->c:Landroid/support/v4/widget/l;

    invoke-virtual {v2}, Landroid/support/v4/widget/l;->c()Landroid/view/View;
...
.method public a(Landroid/support/v4/widget/l;)V
    .locals 0

    iput-object p1, p0, Landroid/support/v4/widget/g;->c:Landroid/support/v4/widget/l;
...
.method public a(Landroid/view/View;FF)V
    ...
    invoke-virtual {v0, p1}, Landroid/support/v4/widget/DrawerLayout;->f(Landroid/view/View;)F
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v4/widget/l;->a(II)Z
...
.method public b(II)V
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/widget/DrawerLayout;->c(Landroid/view/View;)I
    ...
    invoke-virtual {v1, v0, p2}, Landroid/support/v4/widget/l;->a(Landroid/view/View;I)V
