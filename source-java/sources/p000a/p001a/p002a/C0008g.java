...
public class C0008g extends AbstractC0025e {
    ...
    public void mo20e(C0021a c0021a) {
        c0021a.m38e(4);
        c0021a.m43h(this.f12a);
        c0021a.m29a(this.f13b, 1);
        if (this.f13b != null) {
    ...
    public void mo21f(C0021a c0021a) {
        ...
        if (c0021a.m39f() != 0) {
            ...
            if (this.f13b == null) {
                ...
                this.f13b = new C0011j[m39f];
            }
            C0021a m27a = c0021a2.m27a(i);
            for (int i2 = 0; i2 < m39f; i2++) {
                if (this.f13b[i2] == null) {
                    this.f13b[i2] = new C0011j();
                }
                this.f13b[i2].mo21f(m27a);
            }
        }
    }
}
