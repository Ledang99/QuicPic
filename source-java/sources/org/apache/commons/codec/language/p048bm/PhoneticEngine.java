...
import org.apache.commons.codec.language.p048bm.Rule;
...
public class PhoneticEngine {
    ...
    static final class PhonemeBuilder {
        ...
        /* synthetic */ PhonemeBuilder(Set set, C14271 c14271) {
        ...
        public RulesApplication invoke() {
            ...
            if (list != null) {
                ...
                while (true) {
                    ...
                    if (next.patternAndContextMatches(this.input, this.f5016i)) {
    ...
    public String encode(String str, Languages.LanguageSet languageSet) {
        ...
        String trim = str.toLowerCase(Locale.ENGLISH).replace('-', TokenParser.f5042SP).trim();
        ...
        int i = C14271.$SwitchMap$org$apache$commons$codec$language$bm$NameType[this.nameType.ordinal()];
        if (i == 1) {
