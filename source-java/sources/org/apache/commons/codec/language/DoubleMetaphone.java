...
public class DoubleMetaphone implements StringEncoder {
    ...
    private boolean conditionCH1(String str, int i) {
        if (!contains(str, 0, 4, "VAN ", "VON ") && !contains(str, 0, 3, "SCH") && !contains(str, i - 2, 6, "ORCHES", "ARCHIT", "ORCHID") && !contains(str, i + 2, 1, "T", "S")) {
    ...
    private int handleC(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        if (!contains(str, i, 2, "CI", "CE", "CY")) {
            doubleMetaphoneResult.append('K');
            return contains(str, i + 1, 2, " C", " Q", " G") ? i + 3 : (!contains(str, i + 1, 1, "C", "K", "Q") || contains(str, i + 1, 2, "CE", "CI")) ? i + 1 : i + 2;
        }
    ...
    private int handleG(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i == 0 && (charAt(str, i + 1) == 'Y' || contains(str, i + 1, 2, ES_EP_EB_EL_EY_IB_IL_IN_IE_EI_ER))) {
            doubleMetaphoneResult.append('K', 'J');
            return i + 2;
        }
        if ((contains(str, i + 1, 2, "ER") || charAt(str, i + 1) == 'Y') && !contains(str, 0, 6, "DANGER", "RANGER", "MANGER") && !contains(str, i - 1, 1, "E", "I") && !contains(str, i - 1, 3, "RGY", "OGY")) {
            doubleMetaphoneResult.append('K', 'J');
            return i + 2;
        }
    ...
    private int handleJ(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if (i == 0 && !contains(str, i, 4, "JOSE")) {
            ...
            doubleMetaphoneResult.append('J', TokenParser.f5042SP);
        } else if (!contains(str, i + 1, 1, L_T_K_S_N_M_B_Z) && !contains(str, i - 1, 1, "S", "K", "L")) {
            doubleMetaphoneResult.append('J');
        }
        return charAt(str, i + 1) == 'J' ? i + 2 : i + 1;
    }
    ...
    private int handleS(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i, boolean z) {
        ...
        if ((i == 0 && contains(str, i + 1, 1, "M", "N", "L", "W")) || contains(str, i + 1, 1, "Z")) {
            doubleMetaphoneResult.append('S', 'X');
            return contains(str, i + 1, 1, "Z") ? i + 2 : i + 1;
        }
        ...
        return contains(str, i + 1, 1, "S", "Z") ? i + 2 : i + 1;
    }
    ...
    private int handleW(String str, DoubleMetaphoneResult doubleMetaphoneResult, int i) {
        ...
        if (i == 0 && (isVowel(charAt(str, i + 1)) || contains(str, i, 2, "WH"))) {
