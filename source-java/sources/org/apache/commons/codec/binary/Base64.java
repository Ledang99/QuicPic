    ...
    void encode(byte[] bArr, int i, int i2, BaseNCodec.Context context) {
        ...
        if (i2 >= 0) {
            ...
            while (i3 < i2) {
                ...
                if (context.modulus == 0) {
                    int i6 = context.pos;
                    context.pos = i6 + 1;
                    ensureBufferSize[i6] = this.encodeTable[(context.ibitWorkArea >> 18) & MASK_6BITS];
                    int i7 = context.pos;
                    context.pos = i7 + 1;
                    ensureBufferSize[i7] = this.encodeTable[(context.ibitWorkArea >> 12) & MASK_6BITS];
                    int i8 = context.pos;
                    context.pos = i8 + 1;
                    ensureBufferSize[i8] = this.encodeTable[(context.ibitWorkArea >> 6) & MASK_6BITS];
                    int i9 = context.pos;
                    context.pos = i9 + 1;
                    ensureBufferSize[i9] = this.encodeTable[context.ibitWorkArea & MASK_6BITS];
        ...
        if (i11 != 0) {
            if (i11 == 1) {
                int i12 = context.pos;
                context.pos = i12 + 1;
                ensureBufferSize2[i12] = this.encodeTable[(context.ibitWorkArea >> 2) & MASK_6BITS];
                int i13 = context.pos;
                context.pos = i13 + 1;
                ensureBufferSize2[i13] = this.encodeTable[(context.ibitWorkArea << 4) & MASK_6BITS];
                if (this.encodeTable == STANDARD_ENCODE_TABLE) {
                    int i14 = context.pos;
                    context.pos = i14 + 1;
                    ensureBufferSize2[i14] = 61;
                    int i15 = context.pos;
                    context.pos = i15 + 1;
                    ensureBufferSize2[i15] = 61;
                }
            } else {
                if (i11 != 2) {
                    throw new IllegalStateException("Impossible modulus " + context.modulus);
                ...
                int i16 = context.pos;
                context.pos = i16 + 1;
                ensureBufferSize2[i16] = this.encodeTable[(context.ibitWorkArea >> 10) & MASK_6BITS];
                int i17 = context.pos;
                context.pos = i17 + 1;
                ensureBufferSize2[i17] = this.encodeTable[(context.ibitWorkArea >> 4) & MASK_6BITS];
                int i18 = context.pos;
                context.pos = i18 + 1;
                ensureBufferSize2[i18] = this.encodeTable[(context.ibitWorkArea << 2) & MASK_6BITS];
                if (this.encodeTable == STANDARD_ENCODE_TABLE) {
                    int i19 = context.pos;
                    context.pos = i19 + 1;
