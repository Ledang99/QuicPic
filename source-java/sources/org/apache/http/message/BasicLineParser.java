...
public class BasicLineParser implements LineParser {
    ...
    public boolean hasProtocolVersion(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor) {
        ...
        while (true) {
            ...
            if (charArrayBuffer.charAt(pos + i) != protocol.charAt(i)) {
                z2 = false;
            }
            z = z2;
            i++;
    ...
    public StatusLine parseStatusLine(CharArrayBuffer charArrayBuffer, ParserCursor parserCursor) throws ParseException {
        ...
        try {
            ...
            try {
                int i2 = indexOf;
                return createStatusLine(parseProtocolVersion, Integer.parseInt(substringTrimmed), i2 < upperBound ? charArrayBuffer.substringTrimmed(i2, upperBound) : "");
            } catch (NumberFormatException e) {
                throw new ParseException("Status line contains invalid status code: " + charArrayBuffer.substring(pos, upperBound));
            }
