...
public class ServerBootstrap {
    ...
    public HttpServer create() {
        ...
        HttpService httpService = new HttpService(httpProcessor, connectionReuseStrategy, httpResponseFactory == null ? DefaultHttpResponseFactory.INSTANCE : httpResponseFactory, httpRequestHandlerMapper, this.expectationVerifier);
        ...
        if (httpConnectionFactory == null) {
            ...
            httpConnectionFactory = connectionConfig != null ? new DefaultBHttpServerConnectionFactory(connectionConfig) : DefaultBHttpServerConnectionFactory.INSTANCE;
        }
        ...
        return new HttpServer(i2, inetAddress, socketConfig, serverSocketFactory, httpService, httpConnectionFactory, this.sslSetupHandler, exceptionLogger);
    }
