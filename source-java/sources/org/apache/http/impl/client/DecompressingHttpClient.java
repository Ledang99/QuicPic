...
public class DecompressingHttpClient implements HttpClient {
    ...
    public HttpResponse execute(HttpHost httpHost, HttpRequest httpRequest, HttpContext httpContext) throws IOException, ClientProtocolException {
        ...
        this.acceptEncodingInterceptor.process(entityEnclosingRequestWrapper, basicHttpContext);
        HttpResponse execute = this.backend.execute(httpHost, entityEnclosingRequestWrapper, basicHttpContext);
        try {
            this.contentEncodingInterceptor.process(execute, basicHttpContext);
