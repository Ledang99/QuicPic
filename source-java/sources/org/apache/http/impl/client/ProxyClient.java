...
public class ProxyClient {
    ...
    public Socket tunnel(HttpHost httpHost, HttpHost httpHost2, Credentials credentials) throws IOException, HttpException {
        ...
        while (true) {
            ...
            HttpResponse execute = this.requestExec.execute(basicHttpRequest, create, basicHttpContext);
        ...
        create.close();
        throw new org.apache.http.impl.execchain.TunnelRefusedException("CONNECT refused by proxy: " + httpResponse.getStatusLine(), httpResponse);
    }
}
