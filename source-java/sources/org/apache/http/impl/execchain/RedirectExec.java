...
public class RedirectExec implements ClientExecChain {
    ...
    /* JADX WARN: Type inference failed for: r0v21, types: [org.apache.http.conn.routing.HttpRoutePlanner] */
    /* JADX WARN: Type inference failed for: r9v3, types: [org.apache.http.HttpRequest, org.apache.http.client.methods.HttpRequestWrapper] */
    ...
    */
    public CloseableHttpResponse execute(HttpRoute httpRoute, HttpRequestWrapper httpRequestWrapper, HttpClientContext httpClientContext, HttpExecutionAware httpExecutionAware) throws IOException, HttpException {
        ...
        while (true) {
            CloseableHttpResponse execute = this.requestExecutor.execute(httpRoute2, httpRequestWrapper2, httpClientContext, httpExecutionAware);
            try {
                ...
                httpRoute2 = this.routePlanner.determineRoute(extractHost, wrap, httpClientContext);
