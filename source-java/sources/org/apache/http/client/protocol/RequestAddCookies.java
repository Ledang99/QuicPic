...
public class RequestAddCookies implements HttpRequestInterceptor {
    ...
    public void process(HttpRequest httpRequest, HttpContext httpContext) throws HttpException, IOException {
        ...
        RequestConfig requestConfig2 = adapt.getRequestConfig();
        String cookieSpec = requestConfig2.getCookieSpec();
        String str = cookieSpec == null ? CookieSpecs.DEFAULT : cookieSpec;
        ...
        for (Cookie cookie : cookies) {
            CookieSpecProvider cookieSpecProvider = lookup;
            HttpClientContext httpClientContext = adapt;
            Date date2 = date;
            List<Cookie> list = cookies;
            if (cookie.isExpired(date2)) {
                routeInfo = httpRoute;
        ...
        Date date3 = date;
        if (z) {
            cookieStore.clearExpired(date3);
        }
